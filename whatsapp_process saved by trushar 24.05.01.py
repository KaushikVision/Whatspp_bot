...
class WhatsappProcess:
                        ...
                        if(str(col_a) == '1.0'):
                            ...
                            if(valid_time):
                                ...
                                find_proper = WebDriverWait(driver, 10).until(EC.presence_of_all_elements_located(
                                    (By.XPATH, "//span[contains(@class,'x1iyjqo2 x6ikm8r x10wlt62 x1n2onr6 xlyipyv xuxw1ft x1rg5ohu _ao3e')]")))
                                print(find_proper, '$$$$')
                                ...
                                if(senMessageStatus):
                                    ...
                                    sendInput = WebDriverWait(driver, 20).until(EC.presence_of_element_located(
                                        (By.XPATH, "//div[contains(@contenteditable, 'true')][contains(@role, 'textbox')][contains(@title, 'Type a message')]")))
    ...
    def whatsapp_auto_04(self):
        try:
            ...
            logging.info("Function: whatsapp_auto_04 (Whatsapp connection error)")
